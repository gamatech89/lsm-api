...
class BackupFailedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->action('View Project', config('app.frontend_url') . "/projects/{$project->id}?section=backups")
    ...
    public function toSlack(object $notifiable): SlackMessage
    {
        ...
        return (new SlackMessage)
            ...
            ->attachment(function ($attachment) use ($project) {
                $attachment
                    ->title($project->name, config('app.frontend_url') . "/projects/{$project->id}?section=backups")
                    ->fields([
